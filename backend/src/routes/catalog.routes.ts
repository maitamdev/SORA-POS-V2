...
productRoutes.post('/bulk', roleMiddleware('admin', 'manager', 'cashier'), validateMiddleware(productBulkCreateSchema), ProductController.createBulk);
productRoutes.post('/', roleMiddleware('admin', 'manager', 'cashier'), validateMiddleware(productCreateSchema), ProductController.create);
productRoutes.put('/:id', roleMiddleware('admin', 'manager', 'cashier'), validateMiddleware(productUpdateSchema), ProductController.update);
productRoutes.delete('/all', roleMiddleware('admin'), ProductController.deleteAll);
productRoutes.delete('/:id', roleMiddleware('admin', 'manager', 'cashier'), ProductController.delete);
